        ...
        <form action="/workgroup/store" method="POST">
            ...
            <div class="card-body">     
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control col-lg-11 col-6" placeholder="Cth. WR I" value="{{$data['nama']}}">
                ...
                <div class="form-group">
                    ...
                    <select id="jabatan" class="form-control col-lg-11 col-6" type="text" name='controller' placeholder="Cth. Wakil Rektor Bidang Akademik dan Kemahasiswaan" value="{{$data['controller']}}">
