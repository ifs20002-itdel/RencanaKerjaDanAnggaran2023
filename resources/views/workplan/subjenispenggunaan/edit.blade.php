        ...
        <form action="/subjenispenggunaan/{{$subjenispenggunaan->id}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="namaSubJenisPenggunaan" class="form-control" placeholder="Cth. Biaya Dosen (Gaji, Honor)">{{$subjenispenggunaan->namaSubJenisPenggunaan}} </textarea>
