...
@section('title', 'B. Gaji Tenaga Kependidikan (Gaji Dan Honor)')
@section('breadcrumb1')
    <li class="breadcrumb-item"><a href="/pengajuan">Ajukan Rencana</a></li>
@endsection
@section('breadcrumb2')
    <li class="breadcrumb-item">B. Gaji Tenaga Kependidikan (Gaji Dan Honor)</li>
@endsection
    ...
    <div class="card card-dark">
        ...
        <form action="/pengajuan" method="POST" oninput="multiplyNumbers()">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="jenis" class="form-control" value="1B">
