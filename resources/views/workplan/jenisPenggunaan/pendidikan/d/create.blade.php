...
@section('title', 'D. Biaya Operasional Tidak Langsung')
@section('breadcrumb1')
...
@section('judul', 'D. Biaya Operasional Tidak Langsung (Listrik, Gas, Air, Pemeliharaan Gedung, Pemeliharaan Sarana, Uang Lembur, Telekomunikasi, Konsumsi, Transport, Pajak, Asuransi, dll)')
