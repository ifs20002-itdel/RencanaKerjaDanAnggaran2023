...
@section('title', '4. Biaya PkM')
@section('breadcrumb1')
    <li class="breadcrumb-item"><a href="/addJenisPenggunaan">Add Jenis Penggunaan</a></li>
@endsection
@section('breadcrumb2')
    <li class="breadcrumb-item">4. Biaya PkM</li>
@endsection

@section('judul', '4. Biaya PkM')
    ...
    <div class="card card-dark">
        ...
        <form action="/addJenisPenggunaan" method="POST">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="bagianTable" class="form-control" value="4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="namaAnggaran" class="form-control" placeholder="Cth. Hibah Untuk Kegiatan Pengabdian Masyarakat" value="{{old('namaAnggaran')}}">
