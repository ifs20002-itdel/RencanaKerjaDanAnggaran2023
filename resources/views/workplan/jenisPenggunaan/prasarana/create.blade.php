...
@section('title', '7. Biaya Investasi Prasarana')
@section('breadcrumb1')
    <li class="breadcrumb-item"><a href="/addJenisPenggunaan">Add Jenis Penggunaan</a></li>
@endsection
@section('breadcrumb2')
    <li class="breadcrumb-item">7. Biaya Investasi Prasarana</li>
@endsection
    ...
    <div class="card card-dark">
        ...
        <form action="/addJenisPenggunaan" method="POST">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="bagianTable" class="form-control" value="7">
