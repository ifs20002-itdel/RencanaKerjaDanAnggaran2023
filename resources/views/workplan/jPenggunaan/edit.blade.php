...
<div class="ml-5 col-lg-9 col-6">
    <div class="card card-dark">
        <div class="card-header">
            <h3 class="card-title" style="font-size: 14px;">Edit Jenis Penggunaan</h3>
        </div>
        ...
        <form action="/jp/{{$Jenispenggunaan->id}}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Nama</label>
                    <textarea style="font-size:14px" type="text" name="namaJenisPenggunaan" class="form-control" placeholder="Cth. Biaya Operasional Pendidikan">{{$Jenispenggunaan->namaJenisPenggunaan}}</textarea>
